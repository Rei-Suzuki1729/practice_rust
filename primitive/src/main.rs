fn main() {
// floating
	let float_a = 4.987654;
	let float32_a = 2.34567;
    println!("float_a = {}, float32_a = {}",float_a,float32_a);
// bool 
	let bool_x: bool = false;
	println!("bool_x = {}",bool_x);
// slice array
    slice_array_sample();
// tuple
   let tuple = ("vxworks", 7, "ver");
